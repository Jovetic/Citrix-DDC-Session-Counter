...
Send-SlackMessage -Text ((Get-Content C:\scripts\Citrix\Private\Computers.txt)|Get-DDCServerSessions|Out-string) -Webhook "https://hooks.slack.com/services/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"
